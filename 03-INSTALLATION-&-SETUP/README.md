...
task setup:kind:01-generate-config
task setup:kind:02-create-cluster
...
```
devbox shell # if you haven't already
task setup:gcp:01-init-cli
task setup:gcp:02-enable-apis
task setup:gcp:03-set-region-and-zone
task setup:gcp:04-create-vpc
task setup:gcp:05-create-subnet
task setup:gcp:07-create-all
task setup:gcp:09-clean-up
```
